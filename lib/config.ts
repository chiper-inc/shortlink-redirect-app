...
class ConfigService {
  ...
  public static getInstance(): ConfigService {
    console.log('ConfigService.instance', ConfigService.instance);
  ...
  // Métodos de conveniencia para acceder directamente a secciones específicas
}

// Exportar la instancia única
export const configService = ConfigService.getInstance();

// Exportar las configuraciones para mantener compatibilidad con el código existente
export const appConfig = configService.getConfig();

// También puedes exportar la clase si quieres acceder a métodos específicos
