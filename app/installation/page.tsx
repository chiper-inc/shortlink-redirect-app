        ...
        <div className="md:col-span-7 order-2 md:order-1">
          <div className="pl-6">
            <div className="flex flex-col items-start gap-6">
              ...
              <h1 className="text-5xl md:text-6xl font-extrabold leading-tight">
                <span className="text-[#2F2E4F]">
                  El marketplace que tu negocio necesita
                </span>
              </h1>
            </div>
            <p className="mt-3 text-[#475569] text-lg">
              Accede al portafolio más completo de productos para tu negocio.
              Haz tus pedidos en cualquier momento, recibe en 24-48 horas y
              aprovecha promociones diarias. Escanea el código QR para descargar
              nuestra app.
              <br />
            </p>
          </div>
          ...
          <div className="mt-8 rounded-2xl border border-[#E5EAF2] bg-white shadow-lg p-5 flex flex-row items-center gap-4 [&_ul]:hidden">
            ...
            <div className="flex flex-col justify-center w-full">
              <p className="text-lg md:text-xl font-extrabold text-[#2F2E4F] mb-1 leading-tight">
